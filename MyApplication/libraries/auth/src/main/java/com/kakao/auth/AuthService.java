...
public class AuthService {
     ...
     */
    public static Future<Integer> requestShowAgeAuthDialog(final AccountResponseCallback callback, final Bundle ageAuthParams, final boolean useSmsReceiver) {
        return KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Integer>(callback) {
            @Override
            public Integer call() throws Exception {
                return AgeAuthManager.getInstance().requestShowAgeAuthDialog(ageAuthParams, useSmsReceiver);
            }
        });
    }

    /**
     * @deprecated  replaced by #requestShowAgeAuthDialog(AccountResponseCallback,Bundle,boolean)
     */
    @Deprecated
    public static Future<Integer> requestShowAgeAuthDialog(final AccountResponseCallback callback, final AgeAuthParamBuilder builder, final boolean useSmsReceiver) {
        return KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Integer>(callback) {
            @Override
            public Integer call() throws Exception {
                return AgeAuthManager.getInstance().requestShowAgeAuthDialog(builder.build(), useSmsReceiver);
            }
        });
    }
     ...
     * @param callback 요청 결과에 대한 callback
     */
    public static void requestAccessTokenInfo(final ApiResponseCallback<AccessTokenInfoResponse> callback) {
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<AccessTokenInfoResponse>(callback) {
            @Override
            public AccessTokenInfoResponse call() throws Exception {
                return AuthApi.getInstance().requestAccessTokenInfo();
            }
        });
    }
}
