...
public class KakaoNaviWebViewActivity extends Activity {
    ...
    private void showSettingsAlertDialog() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this, android.R.style.Theme_DeviceDefault_Light_Dialog_Alert).setTitle(getResources().getString(R.string.permission_error_title))
