...
public class KakaoTalkService {
        ...
        if (instance == null) {
            synchronized (KakaoTalkService.class) {
                if (instance == null) {
                    ...
                    instance = new KakaoTalkService(configuration);
                }
            }
        }
        return instance;
    ...
    KakaoTalkService(final RequestConfiguration configuration) {
    ...
    public void requestSendMessage(final TalkResponseCallback<Boolean> callback,
        ...
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Boolean>(callback) {
            ...
            public Boolean call() throws Exception {
                SendMessageRequest request = new SendMessageRequest(getRequestConfiguration(), receiverInfo, templateId, args);
                return KakaoTalkApi.getInstance().requestSendV2Message(request);
            }
        });
    }
    ...
    public void requestSendMessage(final TalkResponseCallback<Boolean> callback,
        ...
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Boolean>(callback) {
            @Override
            public Boolean call() throws Exception {
                DefaultMessageRequest request = getDefaultMessageRequest(getRequestConfiguration(), receiverInfo, templateParams);
                return KakaoTalkApi.getInstance().requestSendV2Message(request);
            }
        });
    }
    ...
    public void requestSendMemo(final TalkResponseCallback<Boolean> callback,
        ...
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Boolean>(callback) {
            @Override
            public Boolean call() throws Exception {
                SendMemoRequest request = new SendMemoRequest(getRequestConfiguration(), templateId, args);
                return KakaoTalkApi.getInstance().requestSendV2Memo(request);
            }
        });
    }
    ...
    public void requestSendMemo(final TalkResponseCallback<Boolean> callback,
        ...
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Boolean>(callback) {
            @Override
            public Boolean call() throws Exception {
                DefaultMemoRequest request = getDefaultMemoRequest(getRequestConfiguration(), templateParams);
                return KakaoTalkApi.getInstance().requestSendV2Memo(request);
            }
        });
    }
