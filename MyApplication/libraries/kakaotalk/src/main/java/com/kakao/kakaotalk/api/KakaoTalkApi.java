...
import com.kakao.kakaotalk.v2.DefaultMemoRequest;
import com.kakao.kakaotalk.v2.DefaultMessageRequest;
...
public class KakaoTalkApi {
     ...
     */
    public boolean requestSendV2Message(final com.kakao.kakaotalk.v2.SendMessageRequest request) throws Exception {
        SingleNetworkTask networkTask = new SingleNetworkTask();
        ResponseData result = networkTask.requestApi(request);
        new BlankApiResponse(result);
        return true;
    }

    public boolean requestSendV2Message(final DefaultMessageRequest request) throws Exception {
        SingleNetworkTask networkTask = new SingleNetworkTask();
        ResponseData result = networkTask.requestApi(request);
        new BlankApiResponse(result);
        return true;
     ...
     * @throws Exception if request fails
     */
    public boolean requestSendV2Memo(final com.kakao.kakaotalk.v2.SendMemoRequest request) throws Exception {
        SingleNetworkTask networkTask = new SingleNetworkTask();
        ResponseData result = networkTask.requestApi(request);
        new BlankApiResponse(result);
        return true;
    ...
    public boolean requestSendV2Memo(final DefaultMemoRequest request) throws Exception {
        SingleNetworkTask networkTask = new SingleNetworkTask();
        ResponseData result = networkTask.requestApi(request);
        new BlankApiResponse(result);
        return true;
