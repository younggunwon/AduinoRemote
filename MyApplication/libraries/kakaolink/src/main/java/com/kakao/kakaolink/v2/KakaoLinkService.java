...
/**
 * Class for sending KakaoTalk messages using KakaoLink 4.0 API.
 * @author kevin.kang
...
public class KakaoLinkService {
    ...
    /**
     * Returns a singleton instance for KakaoLink 4.0 API.
    ...
    /**
     * Send KakaoLink 4.0 message with custom templates. Template id and arguments should be provided.
    ...
    /**
     * Send KakaoLink 4.0 message with default templates.
     * @param context Context to start an activity for KakaoLink
