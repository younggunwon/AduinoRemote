...
public class FriendsMainActivity extends BaseActivity implements OnClickListener, IFriendListCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button talkButton = (Button) findViewById(R.id.all_talk_friends);
        Button storyButton = (Button) findViewById(R.id.all_story_friends);
        Button talkStoryButton = (Button) findViewById(R.id.all_talk_and_story_friends);
