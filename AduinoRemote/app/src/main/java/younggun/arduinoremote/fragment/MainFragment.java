...
public class MainFragment extends Fragment implements DialogInterface.OnDismissListener {
   ...
   void startRemote(int $code, String $address) {
       ...
       switch ($code) {
           ...
           case 2 :fragment = new SRFragment(); break;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action) || BluetoothDevice.ACTION_CLASS_CHANGED.equals(action) || BluetoothDevice.ACTION_NAME_CHANGED.equals(action)) { //|| BluetoothDevice.ACTION_NAME_CHANGED.equals(action)
